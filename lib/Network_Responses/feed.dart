...
class ProfileFeed{
  ...
  ProfileFeed._create(this.user_id){
    posts = [];
  }

  static Future<ProfileFeed> create(int user_id, context) async {
    var component = ProfileFeed._create(user_id);

    var response = await FeedNetwork().getProfileFeed(user_id);
